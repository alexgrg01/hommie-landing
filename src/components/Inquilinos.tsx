...
import { Video, Brain, BadgeCheck } from "lucide-react"
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-md">
              Onboarding 100% digital. Buscar y aplicar es gratis, sin
              comisiones de agencia. Compañeros elegidos por compatibilidad
              real.
            </p>
            <a
              href="#waitlist"
